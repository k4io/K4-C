...
uintptr_t pools_offset = 0xBC7980;
/*
 /* GenericInstMethod :
	|
...
public:
	...
	static uint64_t CreatePlayerProjectileUpdate()
	{
		...
		uint64_t update = *reinterpret_cast<uint64_t*>(mem::game_assembly_base + 56715248); //"Method$Facepunch.Pool.Get<PlayerProjectileUpdate>()",
