...
auto gameAssembly = GetModuleHandleA(_("GameAssembly.dll"));
...
namespace Core {
	...
	public:
		...
		static String* New(const char* str) {
			return call<String*, const char*>(_("il2cpp_string_new"), str);
		}
	};
	template<typename T = void*>
	struct List {
...
public:
	char* name() {
		return call<char*, Il2CppType*>(_("il2cpp_type_get_name"), this);
	}
};
...
public:
	uint32_t paramCount() {
		return call<uint32_t, Il2CppMethod*>(_("il2cpp_method_get_param_count"), this);
	}

	Il2CppType* retType() {
		return call<Il2CppType*, Il2CppMethod*>(_("il2cpp_method_get_return_type"), this);
	}

	Il2CppType* getParam(uint32_t idx) {
		return call<Il2CppType*, Il2CppMethod*, uint32_t>(_("il2cpp_method_get_param"), this, idx);
	}

	char* name() {
		return call<char*, Il2CppMethod*>(_("il2cpp_method_get_name"), this);
	}
};

uint64_t il2cpp_resolve_icall(const char* str) {
	return call<uint64_t, const char*>(_("il2cpp_resolve_icall"), str);
}
uint64_t il2cpp_object_new(uint64_t klass) {
	return call<uint64_t, uint64_t>(_("il2cpp_object_new"), klass);
}
class Il2CppField {
public:
	char* name() {
		return call<char*, Il2CppField*>(_("il2cpp_field_get_name"), this);
	}

	uint32_t offset() {
		return call<uint32_t, Il2CppField*>(_("il2cpp_field_get_offset"), this);
	}
};
...
public:
	...
	Il2CppMethod* methods(void* iter) {
		return call<Il2CppMethod*, Il2CppClass*, void*>(_("il2cpp_class_get_methods"), this, iter);
	}

	Il2CppField* fields(void* iter) {
		return call<Il2CppField*, Il2CppClass*, void*>(_("il2cpp_class_get_fields"), this, iter);
	}
}; //Size: 0x00C0
...
public:
	...
	uint64_t classcount() {
		return call<uint64_t, Il2CppImage*>(_("il2cpp_image_get_class_count"), this);
	}

	Il2CppClass* get_class(uint64_t idx) {
		return call<Il2CppClass*, Il2CppImage*, uint64_t>(_("il2cpp_image_get_class"), this, idx);
	}
}; //Size: 0x0010
template<typename T = Core::Object_>
System::Array<T*>* il2cpp_array_new(Il2CppClass* klazz, uint64_t length) {
	auto ret = call<System::Array<T*>*, Il2CppClass*, uint64_t>(_("il2cpp_array_new"), klazz, length);
	return ret;
}
...
public:
	size_t assemblyCount() {
		size_t size = 0;
		auto assemblies = call<Il2CppAssembly**, Il2CppDomain*, void*>(_("il2cpp_domain_get_assemblies"), this, &size);
	...
	Il2CppAssembly** assemblies() {
		size_t size = 0;
		return call<Il2CppAssembly**, Il2CppDomain*, void*>(_("il2cpp_domain_get_assemblies"), this, &size);
	}
};

Il2CppDomain* il2cpp_domain_get() {
	return call<Il2CppDomain*>(_("il2cpp_domain_get"));
}
...
uintptr_t init_class(const char* name, const char* name_space = _("")) {
	...
	size_t size = 0;
	auto assemblies = call<Il2CppAssembly**, Il2CppDomain*, void*>(_("il2cpp_domain_get_assemblies"), domain, &size);
